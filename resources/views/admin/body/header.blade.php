...
{{--                            <span class="text-small text-muted ml-auto">Priority : {{ $notificacao->priority_id }}</span>--}}
                        </p>
                        <p class="text-small text-muted m-0">{{ $notificacao->message }}</p>
                    </div>
                </div>
                @endforeach
                @endisset
...
{{--                            <span class="badge badge-pill badge-danger ml-1 mr-1">{{ $notificacoes->count() }}</span>--}}
{{--                            <span class="flex-grow-1"></span>--}}
{{--                            <span class="text-small text-muted ml-auto">{{ $notificacoes->count() }} hours ago</span>--}}
{{--                        </p>--}}
