...
@section('main')
    ...
    <div class="mb-4 col-md-12 mt-3" align="right">
        <button type="button" class="btn btn-info m-1" data-toggle="modal" data-target="#verifyModalContentAtivo"
                data-whatever="@mdo">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
            </svg>
            <span class="ul-btn__text">&nbsp; Criar Novo Registro</span>
        </button>
    </div>
                ...
                <div class="table-responsive">
                    ...
                    <table id="user_table" class="table dataTable-collapse text-center">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width: 45%">ATIVO</th>
                            <th scope="col" style="width: 10%">BLOCO</th>
                            <th scope="col" style="width: 10%">FASE</th>
                            <th scope="col" style="width: 15%">DT. CRIAÇÃO</th>
                        ...
                        @foreach($ativos as $key => $ativo)
                            <tr>
                                <td style="width: 7%">{{ ++$key }}</td>
                                <td style="width: 45%">{{ $ativo->tags }}</td>
                                <td style="width: 10%">
                                ...
                                <td style="width: 13%">
                                    ...
                                    <a href="{{ route('ativos.destroy',$ativo->id) }}" class="btn btn-outline-danger btn-icon m-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="modal fade" id="verifyModalContentAtivo" tabindex="-1" role="dialog"
         aria-labelledby="verifyModalContent" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="verifyModalContent_title">Registrar Ativo</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <form action="{{ route('ativo.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-body">
                                    <div class="row" x-data="{ tags: '' }">
                                        ...
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <select id="ativo_modelo" name="ativo_modelo" class="form-control"
                                                    required="true">
                                        ...
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <select class="form-control" id="sala_area" name="sala_area"
                                                    required="true"
                                                    x-ref="sala_area"
                                                ...
                                                @foreach($assets['ativos_location']->where('tipo','sala_area') as $sala_area)
                                                    <option
                                                        value="{{ $sala_area->id }}">{{ $sala_area->nome }}</option>
                                                @endforeach
                                            </select>
                                        </div>
